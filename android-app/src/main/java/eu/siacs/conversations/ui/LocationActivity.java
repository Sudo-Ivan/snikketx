...
public abstract class LocationActivity extends ActionBarActivity implements LocationListener {
    ...
    protected void onSaveInstanceState(@NonNull final Bundle outState) {
        ...
        outState.putParcelable(
                KEY_LOCATION, new GeoPoint(center.getLatitude(), center.getLongitude()));
        ...
        try {
            ...
            if (locationManager.getAllProviders().contains(LocationManager.NETWORK_PROVIDER)) {
                ...
                if (lastKnownLocationNetwork != null
                        && LocationHelper.isBetterLocation(
                                lastKnownLocationNetwork, lastKnownLocationGps)) {
            ...
            // If something else is also querying for location more frequently than we are, the
            // battery is already being
