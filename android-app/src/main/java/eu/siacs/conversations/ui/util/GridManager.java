...
public class GridManager {
    ...
    public static void setupLayoutManager(
            final Context context, RecyclerView recyclerView, @DimenRes int desiredSize) {
                        ...
                        new ViewTreeObserver.OnGlobalLayoutListener() {
                            ...
                            public void onGlobalLayout() {
                                ...
                                if (availableWidth == 0) {
                                    Log.e(
                                            Config.LOGTAG,
                                            "GridManager: available width was 0; probably because"
                                                    + " layout was hidden");
                                    return;
                                }
                                ...
                                if (adapter != null && adapter.getItemCount() != 0) {
                                    Log.e(
                                            Config.LOGTAG,
                                            "adapter already has items; just go with it now");
                                    return;
                                }
    ...
    private static void setupLayoutManagerInternal(
            RecyclerView recyclerView, final ColumnInfo columnInfo) {
    ...
    private static ColumnInfo calculateColumnCount(
            Context context, int availableWidth, @DimenRes int desiredSize) {
